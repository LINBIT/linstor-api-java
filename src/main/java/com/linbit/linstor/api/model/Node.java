...
public class Node {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, type, flags, props, netInterfaces, connectionStatus, uuid, storageProviders, resourceLayers, unsupportedProviders, unsupportedLayers, evictionTimestamp);
  }
