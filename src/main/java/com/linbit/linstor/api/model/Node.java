...
public class Node {
  ...
  public enum ConnectionStatusEnum {
    ...
    @JsonCreator
    public static ConnectionStatusEnum fromValue(String input) {
  ...
  @JsonProperty("eviction_timestamp")
  private Long evictionTimestamp = null;
  ...
  **/
  ...
  public Node evictionTimestamp(Long evictionTimestamp) {
  ...
  **/
  ...
  public Node platform(PlatformEnum platform) {
   ...
   * @return platform
  **/
  @Schema(example = "LINUX", description = "Enum describing the satellite's platform (Linux/Windows) ")
  ...
  public Node osVariant(String osVariant) {
   ...
   * @return osVariant
  **/
  @Schema(example = "Ubuntu 18.04.2 LTS", description = "String describing the satellite's OS variant (Linux distri, Windows version) ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, node.name) &&
        ...
        Objects.equals(this.evictionTimestamp, node.evictionTimestamp) &&
        Objects.equals(this.platform, node.platform) &&
        Objects.equals(this.osVariant, node.osVariant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, flags, props, netInterfaces, connectionStatus, uuid, storageProviders, resourceLayers, unsupportedProviders, unsupportedLayers, evictionTimestamp, platform, osVariant);
  }
  ...
  public String toString() {
    ...
    sb.append("    evictionTimestamp: ").append(toIndentedString(evictionTimestamp)).append("\n");
    sb.append("    platform: ").append(toIndentedString(platform)).append("\n");
    sb.append("    osVariant: ").append(toIndentedString(osVariant)).append("\n");
    sb.append("}");
    return sb.toString();
  }
