...
public class Snapshot {
  ...
  @JsonProperty("snapshot_definition_props")
  private Properties snapshotDefinitionProps = null;

  @JsonProperty("resource_definition_props")
  private Properties resourceDefinitionProps = null;
  ...
  **/
  ...
  public Snapshot snapshotDefinitionProps(Properties snapshotDefinitionProps) {
    this.snapshotDefinitionProps = snapshotDefinitionProps;
    return this;
  }

   /**
   * Get snapshotDefinitionProps
   * @return snapshotDefinitionProps
  **/
  @Schema(description = "")
  public Properties getSnapshotDefinitionProps() {
    return snapshotDefinitionProps;
  }

  public void setSnapshotDefinitionProps(Properties snapshotDefinitionProps) {
    this.snapshotDefinitionProps = snapshotDefinitionProps;
  }

  public Snapshot resourceDefinitionProps(Properties resourceDefinitionProps) {
    this.resourceDefinitionProps = resourceDefinitionProps;
    return this;
  }

   /**
   * Get resourceDefinitionProps
   * @return resourceDefinitionProps
  **/
  @Schema(description = "")
  public Properties getResourceDefinitionProps() {
    return resourceDefinitionProps;
  }

  public void setResourceDefinitionProps(Properties resourceDefinitionProps) {
    this.resourceDefinitionProps = resourceDefinitionProps;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, snapshot.name) &&
        ...
        Objects.equals(this.snapshotDefinitionProps, snapshot.snapshotDefinitionProps) &&
        Objects.equals(this.resourceDefinitionProps, snapshot.resourceDefinitionProps) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, resourceName, nodes, props, snapshotDefinitionProps, resourceDefinitionProps, flags, volumeDefinitions, uuid, snapshots);
  }
  ...
  public String toString() {
    ...
    sb.append("    snapshotDefinitionProps: ").append(toIndentedString(snapshotDefinitionProps)).append("\n");
    sb.append("    resourceDefinitionProps: ").append(toIndentedString(resourceDefinitionProps)).append("\n");
