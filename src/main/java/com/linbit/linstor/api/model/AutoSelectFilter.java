...
public class AutoSelectFilter {
  ...
  @JsonProperty("x_replicas_on_different_map")
  private Map<String, Integer> xReplicasOnDifferentMap = null;
  ...
  **/
  ...
  public AutoSelectFilter xReplicasOnDifferentMap(Map<String, Integer> xReplicasOnDifferentMap) {
    this.xReplicasOnDifferentMap = xReplicasOnDifferentMap;
    return this;
  }

  public AutoSelectFilter putXReplicasOnDifferentMapItem(String key, Integer xReplicasOnDifferentMapItem) {
    if (this.xReplicasOnDifferentMap == null) {
      this.xReplicasOnDifferentMap = new HashMap<>();
    }
    this.xReplicasOnDifferentMap.put(key, xReplicasOnDifferentMapItem);
    return this;
  }

   /**
   * Get xReplicasOnDifferentMap
  ...
  **/
  ...
  public void setXReplicasOnDifferentMap(Map<String, Integer> xReplicasOnDifferentMap) {
    this.xReplicasOnDifferentMap = xReplicasOnDifferentMap;
  }
  ...
  **/
  ...
  public AutoSelectFilter portCount(Integer portCount) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.placeCount, autoSelectFilter.placeCount) &&
        ...
        Objects.equals(this.xReplicasOnDifferentMap, autoSelectFilter.xReplicasOnDifferentMap) &&
        ...
        Objects.equals(this.portCount, autoSelectFilter.portCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(placeCount, additionalPlaceCount, nodeNameList, storagePool, storagePoolList, storagePoolDisklessList, notPlaceWithRsc, notPlaceWithRscRegex, replicasOnSame, replicasOnDifferent, xReplicasOnDifferentMap, layerStack, providerList, disklessOnRemaining, disklessType, overprovision, portCount);
  }
  ...
  public String toString() {
    ...
    sb.append("    xReplicasOnDifferentMap: ").append(toIndentedString(xReplicasOnDifferentMap)).append("\n");
