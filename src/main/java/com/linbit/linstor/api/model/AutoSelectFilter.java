...
public class AutoSelectFilter {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(placeCount, additionalPlaceCount, nodeNameList, storagePool, storagePoolList, storagePoolDisklessList, notPlaceWithRsc, notPlaceWithRscRegex, replicasOnSame, replicasOnDifferent, xReplicasOnDifferentMap, layerStack, providerList, disklessOnRemaining, disklessType, overprovision);
  }
