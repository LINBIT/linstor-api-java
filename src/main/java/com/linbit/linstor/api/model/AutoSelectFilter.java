...
public class AutoSelectFilter {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(placeCount, additionalPlaceCount, nodeNameList, storagePool, storagePoolList, notPlaceWithRsc, notPlaceWithRscRegex, replicasOnSame, replicasOnDifferent, layerStack, providerList, disklessOnRemaining, disklessType);
  }
